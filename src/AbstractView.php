...
abstract class AbstractView
{
        ...
        if ($located === false) {
            throw new ViewException(
                ...
                /* translators: %s is replaced with the view path. */
                    \esc_html('Unable to locate view: %s'),
    ...
    protected function locateView($fileNames, string $cacheKey)
    {
        ...
        if (! isset($this->locate)) {
            static::$cache['views'][$cacheKey] = "{$this->getAbsoluteViewPath()}/{$this->getViewFile()}";

            return static::$cache['views'][$cacheKey];
        }
    ...
    protected function getPaths(): array
    {
         ...
         *
         * @param array $filePaths Default is directory in child theme at index 1,
         *                         parent theme at 10, and config at 100.
         */
